...
configs = [
    {
        "name": "Non-Strict",
        "gene_list_path": f'{BASE_PATH}/0_find_gene_lists_intersections/output/GFP_SOX.csv',
        "output_dir": f'{BASE_PATH}/2_check_dysregulation_of_the_intersected_genes/GFP_dysregulation_analysis_SOX'
    },
    {
        "name": "Strict",
        "gene_list_path": f'{BASE_PATH}/0_find_gene_lists_intersections/output/GFP_SOX_strict.csv',
