#!/bin/bash
#SBATCH --job-name=find_common_GFP_SES
...
#SBATCH --error="logs/find_common_GFP_SES.err"
#SBATCH --output="logs/find_common_GFP_SES.out"
...
Rscript scripts/find_common_GFP_SES.R