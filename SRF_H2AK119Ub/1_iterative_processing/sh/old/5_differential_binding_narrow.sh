#!/bin/bash
#SBATCH --job-name=5_differential_binding_narrow
...
#SBATCH --error="logs/5_differential_binding_narrow.err"
#SBATCH --output="logs/5_differential_binding_narrow.out"
...
mkdir -p analysis/{diffbind_narrow,annotation_narrow,qc} logs || { log_message "ERROR: Failed to create directories"; exit 1; }

# Check for required input files
log_message "Checking required input files..."
required_files=(
    "analysis/peaks/GFP_1_narrow_peaks.narrowPeak"
    "analysis/peaks/GFP_2_narrow_peaks.narrowPeak"
    "analysis/peaks/GFP_3_narrow_peaks.narrowPeak"
    "analysis/peaks/YAF_1_narrow_peaks.narrowPeak"
    "analysis/peaks/YAF_2_narrow_peaks.narrowPeak"
    "analysis/peaks/YAF_3_narrow_peaks.narrowPeak"
...
log_message "Starting differential binding analysis for narrow peaks..."
Rscript scripts/5_differential_binding_narrow.R
...
output_files=(
    ...
    "analysis/annotation_narrow/annotation_plots.pdf"
)
...
log_message "Differential binding analysis for narrow peaks completed successfully"