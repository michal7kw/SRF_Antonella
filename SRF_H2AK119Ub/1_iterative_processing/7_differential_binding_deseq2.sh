...
OUTPUT_DIR="/beegfs/scratch/ric.broccoli/kubacki.michal/SRF_H2AK119Ub_cross_V5/SRF_H2AK119Ub/1_iterative_processing/analysis/7_differential_binding_deseq2"

# Create necessary output directories
log_message "Creating output directories..."
mkdir -p logs
mkdir -p ${OUTPUT_DIR}  # For DESeq2 results and annotated results
...
if ! Rscript scripts/5_differential_binding_deseq2.R ${OUTPUT_DIR}; then
