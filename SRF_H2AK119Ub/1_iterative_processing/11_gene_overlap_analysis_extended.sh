...
#### Output files (in ./SRF_H2AK119Ub/1_iterative_processing/analysis/11_gene_overlap_analysis_extended/ relative to project root): ####
...
OUTPUT_DIR_PARAM="./analysis/11_gene_overlap_analysis_extended"
...
python ./scripts/11_gene_overlap_analysis_extended.py "${OUTPUT_DIR_PARAM}"
