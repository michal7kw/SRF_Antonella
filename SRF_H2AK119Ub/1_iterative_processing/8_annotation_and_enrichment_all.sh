...
Rscript scripts/8_annotation_and_enrichment_all.R "${OUTPUT_DIR}" "${INPUT_DIR}"

log_message "Annotation and enrichment analysis completed"

# dos2unix SRF_H2AK119Ub/1_iterative_processing/8_annotation_and_enrichment_all.sh
