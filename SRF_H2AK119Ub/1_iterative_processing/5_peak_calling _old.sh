...
TMPDIR="/beegfs/scratch/ric.broccoli/kubacki.michal/SRF_H2AK119Ub_cross_V5/SRF_H2AK119Ub/1_iterative_processing/tmp_old/${SLURM_ARRAY_TASK_ID}_${SLURM_JOB_ID}"
mkdir -p "$TMPDIR"
chmod 777 "$TMPDIR"
export TMPDIR
