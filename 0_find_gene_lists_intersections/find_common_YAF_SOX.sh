#!/bin/bash
#SBATCH --job-name=find_common_YAF_SOX
...
#SBATCH --error="logs/find_common_YAF_SOX.err"
#SBATCH --output="logs/find_common_YAF_SOX.out"
...
Rscript scripts/find_common_YAF_SOX.R